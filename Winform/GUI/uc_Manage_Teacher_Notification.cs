...
namespace GUI
{
    public partial class uc_Manage_Teacher_Notification : UserControl
    {
        public uc_Manage_Teacher_Notification()
        {
            InitializeComponent();
        }
        ...
        private List<object[]> addUserToDataList()
        {
            ...
            teacherData = bllNotification.PROC_getInfNotification(1);
        ...
        private void uc_Manage_Teacher_Notification_Load(object sender, EventArgs e)
        {
